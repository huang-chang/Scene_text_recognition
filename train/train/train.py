...
if __name__ == '__main__':
    ...
    train_loader = gen('new_ocr_train_name_and_index_third.txt', '/home/vcaadmin/Downloads/text_renderer-master/output/default', batchsize=batch_size, maxlabellength=maxlabellength, imagesize=(img_h, img_w))
    test_loader = gen('new_ocr_test_name_and_index_third.txt', '/home/vcaadmin/Downloads/text_renderer-master/output/default_test', batchsize=batch_size, maxlabellength=maxlabellength, imagesize=(img_h, img_w))
